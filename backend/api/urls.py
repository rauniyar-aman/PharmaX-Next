...
urlpatterns = [
    ...
    path('payment/esewa/initiate-appointment/',  views.AppointmentEsewaInitiateView.as_view(),  name='payment-esewa-initiate-appointment'),
    path('payment/esewa/success-appointment/',   views.AppointmentEsewaSuccessView.as_view(),   name='payment-esewa-success-appointment'),
    path('payment/esewa/failure-appointment/',   views.AppointmentEsewaFailureView.as_view(),   name='payment-esewa-failure-appointment'),
    ...
    path('lab-tests/bookings/<uuid:pk>/tracking/', views.LabTestBookingTrackingView.as_view(), name='lab-test-booking-tracking'),
    path('lab-tests/bookings/<uuid:pk>/share-report/', views.LabReportShareView.as_view(), name='lab-report-share'),
    ...
    path('admin/prescriptions/<uuid:pk>/lab-test-items/',              views.AdminPrescriptionLabTestItemListView.as_view(),    name='admin-prescription-lab-test-items'),
    path('admin/prescriptions/<uuid:pk>/lab-test-items/<uuid:item_id>/', views.AdminPrescriptionLabTestItemDetailView.as_view(), name='admin-prescription-lab-test-item-detail'),
