...
class Medicine(models.Model):
    ...
    # Admin-set free text, deliberately not tied to any calculated discount — price/original_price
    # already shows the real discount, this is for messaging a number can't ("Best Seller").
    promo_badge = models.CharField(max_length=30, null=True, blank=True)
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
