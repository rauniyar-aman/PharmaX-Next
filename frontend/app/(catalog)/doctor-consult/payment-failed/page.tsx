...
function PaymentFailedContent() {
  ...
  const message = (reason && REASON_MESSAGES[reason]) || 'Something went wrong with your payment. Your appointment was not confirmed.'
  ...
  return (
    <div className="max-w-md mx-auto text-center space-y-6 py-8">
      ...
      <div>
        ...
        <p className="text-xs text-on-surface-variant mt-1">The time slot was released — you'll need to book again.</p>
      </div>
